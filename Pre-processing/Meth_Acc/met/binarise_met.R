####################################
##Script taken from Clark et. all ##
####################################
...
# Define I/0
io <- list()
io$indir <- "/home/christos/Desktop/Data/NMTDATA/met"#Raw methylation data folder
io$outdir <- "/home/christos/Desktop/Data/NMTDATA/met/binarised" #Binarised raw methylation data folder
