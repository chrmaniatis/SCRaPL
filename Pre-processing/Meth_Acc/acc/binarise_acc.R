...
io$indir <- "~/SCRaPL/Pre-processing/Meth_Acc/acc"#Raw methylation data folder
io$outdir <- "~/SCRaPL/Pre-processing/Meth_Acc/acc/binarised" #Binarised raw methylation data folder
