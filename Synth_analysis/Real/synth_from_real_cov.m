...
SaveFolder="Coverage/Data/Cnst";%Save folder
Filename="lt_exp_60.csv";%Latent expression rates filename.
SaveFilename="Synth_real_cov_8.mat";%Synthetic data filename.
...
Cap_CpG = randi([5 10],size(dt1,1),1);%Generate methylation coverage
