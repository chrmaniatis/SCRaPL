...
DataFolder='Results/';
TypeOfExp='Coverage/Cnst/';%Type of experiment Real/
FullDataFolder=append(DataFolder,TypeOfExp);%Full data folder
PlotFolder=append('Plots/',TypeOfExp);%Folder with plots

PlotName_cor="Cover_exp_cor.pdf";%Correlation plot name
PlotName_mn="Cover_exp_lt_mn.pdf";%Latent mean plot name
PlotName_sig="Cover_exp_lt_sig.pdf";%Latent sigma plot name
...
mse_sig_all=[];
for ii=1:Num_data
File_Data=sprintf(append(FullDataFolder,'Synth_MT_cov_res_%d.mat'),ii);%Data filename
